...
public class PFRPIDController extends PIDController {
    private final double MAX_CONTROL_EFFORT;
    private final SimpleMotorFeedforward FEED_FORWARD;

    public PFRPIDController(PIDValues pidValues) {
    ...
    public double filteredCalculate(double measurement, double setpoint) {
        ...
        return (
            MathUtil.clamp(rawOutput, -MAX_CONTROL_EFFORT, MAX_CONTROL_EFFORT) +
