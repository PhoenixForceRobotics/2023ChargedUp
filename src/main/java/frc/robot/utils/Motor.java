...
public class Motor extends CANSparkMax {
    ...
    private PFRSimplePIDController positionPID;
    private PFRSimplePIDController velocityPID;
    ...
    public Motor(
        ...
        this.positionPID = new PFRSimplePIDController(positionPID);
        this.velocityPID = new PFRSimplePIDController(velocityPID);
