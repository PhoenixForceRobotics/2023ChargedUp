...
public class JoystickAngle extends CommandBase {
    ...
    {
        arm.setRotationRadiansPerSecond(0); // Resets the radians per second to zero, essentially stopping any movement
    }

    @Override
    public void execute()
    {
        arm.setRotationRadiansPerSecond(operatorController.getLeftYSquared()); // Sets the radians per second to the squared input from the controller
    }
